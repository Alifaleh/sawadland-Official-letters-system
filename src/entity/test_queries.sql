...
(
    'تقليل سعة دولية',
    ' تهديكم شركة ارض السواد لتكنولوجيا المعلومات وخدمات الانترنت أطيب تحياتها...',
    'يرجى التفضل بالموافقة على تقليل السعة {{city}} المستخدمة في محافظة كركوك بمقدار {{decrementAmount}} لتصبح السعة {{afterDecrement}} بدلا" عن {{beforeDecrement}} و على مسار {{path}} و ذلك لحاجتنا لتقليل هذه السعات.',
    'شاكرين تعاونكم معنا...'
    ),
(
    'زيادة سعة محلية',
